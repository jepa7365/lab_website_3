...
app.get('/team_stats', function(req, res) {
  var vn = req.query1.visitor_name;
  var hscore = req.query1.home_score;
  var vscore = req.query1.visitor_score;
  var gdate = req.query1.game_date;
  ...
  db.task('get-everything', task => {
    ...
    .then(info => {
      res.render('pages/team_stats',{
        ...
        game_date: gdate,
        wins: JSON.stringify(info[1])[11],
        losses: JSON.stringify(info[2])[11],
      })
    })
    .catch(error => {
        // display error message in case an error
...
app.get('/player_info/select', function(req, res) {
  var Name = req.query2.name;
  var ID = req.query2.id;
